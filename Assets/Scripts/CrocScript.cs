...
public class CrocScript : MonoBehaviour {
	...
	void Update () {
		...
		if (novoInimigo) {
			...
			inimigoEcolhidoInstance = Instantiate (croc);
			inimigoEcolhidoInstance.name = "croc" + enemiesList.Count;
			inimigoEcolhidoInstance.transform.position = posNovoInimigo;
			enemiesList.Add(new EnemiesList(inimigoEcolhidoInstance.name,inimigoEcolhidoInstance,200,Instantiate (alvo)));
			inimigoEcolhidoInstance = Instantiate (croc);
			inimigoEcolhidoInstance.name = "croc" + enemiesList.Count;
			inimigoEcolhidoInstance.transform.position = posNovoInimigo;
			enemiesList.Add(new EnemiesList(inimigoEcolhidoInstance.name,inimigoEcolhidoInstance,200,Instantiate (alvo)));
